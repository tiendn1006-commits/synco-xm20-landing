    ...
    <section className="py-xxl bg-surface-container-lowest">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        <div ref={refLeft} className={`anim-left ${visibleLeft ? 'anim-visible' : ''}`}>
          ...
          <h2 className="font-display-lg text-white mb-6 text-3xl md:text-5xl">XTALK MASTER XM20 –<br/><span className="italic text-red-600">BEYOND THE STAGE</span></h2>
          <p className="text-secondary mb-5 leading-relaxed text-sm md:text-base">
            Một sân khấu hoàn hảo không bắt đầu từ ánh đèn, mà được tạo nên từ những gì diễn ra phía sau. Sự kiện ra mắt Synco Xtalk Master XM20 là nơi hé lộ toàn bộ câu chuyện hậu trường – nơi công nghệ, con người và sáng tạo kết nối để tạo nên những khoảnh khắc đáng nhớ trên sân khấu.
          </p>
          <p className="text-secondary mb-8 leading-relaxed text-sm md:text-base">
            Tại đây, Xtalk Master XM20 không chỉ là một thiết bị – mà là "trái tim" đứng sau mỗi khung hình, mỗi sân khấu, mỗi câu chuyện được kể.
          </p>
        ...
        <div ref={refRight} className={`relative anim-right ${visibleRight ? 'anim-visible' : ''} mt-8 lg:mt-0`}>
          <div className="relative z-10 w-full overflow-hidden rounded-lg">
            <img src={conceptImg} alt="Xtalk Master XM20 Beyond The Stage" className="w-full h-auto object-cover" />
          </div>
        </div>
      </div>
    </section>
